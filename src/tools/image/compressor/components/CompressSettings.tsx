...
export function CompressSettings() {
  ...
  return (
    <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-6">
      <h3 className="text-lg font-semibold text-white mb-4">压缩设置</h3>
      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-neutral-300">压缩优化</h4>
          </div>
          ...
          <div className="space-y-4 pl-6">
            ...
            <label className="flex items-start gap-2 text-sm">
              <input
                ...
                className="rounded mt-0.5 accent-white"
              />
              <div>
                <div className="font-medium text-neutral-300">去除元数据</div>
          ...
          {enableResize && (
            <div className="space-y-3 pl-6">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs text-neutral-400 mb-1">宽度(px)</label>
                  <input
                    type="number"
                    min="1"
                    value={resizeWidth || ''}
                    ...
                    placeholder="auto"
                    className="w-full px-3 py-2 bg-neutral-700 border border-neutral-600 rounded-lg text-sm text-white placeholder-neutral-500"
                  />
                </div>
                <div>
                  <label className="block text-xs text-neutral-400 mb-1">高度(px)</label>
                  <input
                    type="number"
                    min="1"
                    value={resizeHeight || ''}
