...
import { ConvertTask } from '../types';
import { formatFileSize } from '../utils/formatUtils';

function TaskItem({ task }: { task: ConvertTask }) {
  const { removeTask } = useImageConverterStore();
...
export function FileList() {
  const { tasks, clearTasks } = useImageConverterStore();
