...
import { formatJSON } from "@ai-assistant/utils/formatters";
    ...
    >
      ...
      {language === "json" && (
        <button
          ...
          className={`${isFullHeight ? "mt-2 flex-shrink-0" : "mt-2"} inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-foreground dark:text-muted-foreground hover:text-blue-600 dark:hover:text-blue-400 transition-colors`}
        >
