...
import { Form, FormField, FormItem, FormMessage } from "@ai-assistant/components/ui/form";
import { Input } from "@ai-assistant/components/ui/input";
import { providerSchema, type ProviderFormData } from "@ai-assistant/lib/schemas/provider";
...
import {
  providerPresets,
  type ProviderPreset,
} from "@ai-assistant/config/claudeProviderPresets";
import {
  codexProviderPresets,
  type CodexProviderPreset,
} from "@ai-assistant/config/codexProviderPresets";
import {
  geminiProviderPresets,
  type GeminiProviderPreset,
} from "@ai-assistant/config/geminiProviderPresets";
import {
  opencodeProviderPresets,
  type OpenCodeProviderPreset,
} from "@ai-assistant/config/opencodeProviderPresets";
import { OpenCodeFormFields } from "./OpenCodeFormFields";
import type { OpenCodeModel } from "@ai-assistant/types";
import type { UniversalProviderPreset } from "@ai-assistant/config/universalProviderPresets";
import { applyTemplateValues } from "@ai-assistant/utils/providerConfigUtils";
import { mergeProviderMeta } from "@ai-assistant/utils/providerMetaUtils";
import { getCodexCustomTemplate } from "@ai-assistant/config/codexTemplates";
...
import { useProvidersQuery } from "@ai-assistant/lib/query/queries";
  ...
  const handleSubmit = (values: ProviderFormData) => {
    ...
    if (!isEditMode && draftCustomEndpoints.length > 0) {
      const customEndpointsToSave: Record<
        string,
        import("@ai-assistant/types").CustomEndpoint
      > = draftCustomEndpoints.reduce(
        ...
        {} as Record<string, import("@ai-assistant/types").CustomEndpoint>,
      );
