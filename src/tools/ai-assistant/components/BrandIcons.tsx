...
// 导入本地 SVG 图标
import ClaudeSvg from "@ai-assistant/icons/extracted/claude.svg?url";
import OpenAISvg from "@ai-assistant/icons/extracted/openai.svg?url";
import GeminiSvg from "@ai-assistant/icons/extracted/gemini.svg?url";
