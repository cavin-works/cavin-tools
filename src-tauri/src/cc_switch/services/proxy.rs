...
use crate::cc_switch::services::provider::write_live_snapshot;
...
impl ProxyService {
    ...
    async fn sync_live_to_provider(&self, app_type: &AppType) -> Result<(), String> {
        let live_config = match app_type {
            ...
            AppType::Cursor => {
                // Cursor doesn't support proxy features
                return Err("Cursor 不支持代理功能".to_string());
            }
        };
    ...
    async fn sync_live_config_to_provider(
        ...
        match app_type {
            ...
            AppType::Cursor => {
                // Cursor doesn't support proxy features, skip silently
            }
        }
    ...
    pub fn detect_takeover_in_live_config_for_app(&self, app_type: &AppType) -> bool {
        match app_type {
            ...
            AppType::Cursor => {
                // Cursor doesn't support proxy takeover
                false
            }
        }
    }
